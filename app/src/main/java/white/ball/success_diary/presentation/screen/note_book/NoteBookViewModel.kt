package white.ball.success_diary.presentation.screen.note_book
...
import white.ball.success_diary.presentation.model.toNoteDomainModel
import white.ball.success_diary.presentation.model.toNoteModelUI
...
class NoteBookViewModel @Inject constructor(
    ...
    suspend fun addNote(note: NoteModelUI) {
        try {
            val noteDomain = note.toNoteDomainModel()
    ...
    suspend fun editNote(note: NoteModelUI) {
        noteUseCases.editNoteUseCase(note.toNoteDomainModel())
    }

    suspend fun deleteNote(note: NoteModelUI) {
        noteUseCases.deleteNoteUseCase(note.toNoteDomainModel())
    }
